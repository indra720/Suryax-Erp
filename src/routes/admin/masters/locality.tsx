...
export const Route = createFileRoute("/admin/masters/locality")({
  component: LocalityPage,
});

function LocalityPage() {
  const [data] = useState([
    { name: "Mansarover", status: "Active" },
  ]);
  ...
  return (
    <div className="space-y-3 w-full max-w-full">
      ...
      <div className="flex items-center justify-between px-4 py-2.5 bg-white border border-gray-200 rounded-xl shadow-xs">
        <h1 className="text-lg font-bold text-gray-800">Locality Master</h1>
        <Dialog>
          ...
          <DialogContent className="max-w-sm">
            <DialogHeader><DialogTitle>Add Locality</DialogTitle></DialogHeader>
            <div className="space-y-3 mt-2">
              <div><label className="text-xs font-bold">Locality Name</label><input type="text" className="w-full border rounded p-2 text-xs" /></div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-xs">
            <thead className="bg-gray-50 border-b">
              <tr><th className="p-2">Locality Name</th><th className="p-2">Status</th><th className="p-2">Action</th></tr>
            </thead>
