...
export const Route = createFileRoute("/admin/projects/update-inventory")({
      ...
      <div className="px-4 sm:px-6 pb-6 space-y-4">
        ...
        <div className="bg-white border border-gray-200 rounded-xl shadow-sm p-4">
          <div className="flex flex-col lg:flex-row lg:items-center gap-3 flex-wrap">
            ...
            <select className="h-9 border border-gray-200 rounded-lg px-3 text-sm text-gray-700 focus:outline-none focus:ring-1 focus:ring-[#6732F2] bg-white min-w-[150px]">
              <option>Flat On Each Floor</option>
            </select>
        ...
        <div className="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
            ...
            <table className="w-full text-sm text-left min-w-[1300px]">
              <thead>
                <tr className="bg-gray-50 border-b border-gray-200">
                  ...
                  <th className="px-4 py-3 font-semibold text-gray-600 whitespace-nowrap">
                    Flat Facing <span className="text-red-500">*</span>
                  </th>
                  <th className="px-4 py-3 font-semibold text-gray-600 whitespace-nowrap">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 px-4 py-3 border-t border-gray-100 bg-gray-50/50">
            ...
            <p className="text-xs text-gray-500">1 flat row</p>
          </div>
        </div>
      </div>
