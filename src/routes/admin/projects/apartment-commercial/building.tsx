      ...
      <div className=" pb-6 space-y-4">
        ...
        <div className="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-3 p-4 border-b border-gray-100">
            ...
            <select className="h-9 border border-gray-200 rounded-lg px-3 text-sm text-gray-700 focus:outline-none focus:ring-1 focus:ring-[#6732F2] bg-white min-w-[180px] flex-1">
            ...
            <table className="w-full text-sm text-left min-w-[1100px]">
              <thead>
                <tr className="bg-gray-50 border-b border-gray-200">
                  ...
                  <th className="px-4 py-3 font-semibold text-gray-600 whitespace-nowrap">
                    Total Flat <span className="text-red-500">*</span>
                  </th>
                  <th className="px-4 py-3 font-semibold text-gray-600 whitespace-nowrap">
                ...
                <tr className="bg-gray-50/80 border-b border-gray-200">
                  ...
                  <td className="px-4 py-3">
                    <input
                      ...
                      className="w-24 border border-gray-200 rounded px-2 py-1.5 text-xs bg-gray-100 focus:outline-none"
                      readOnly
                    />
                  </td>
                  <td className="px-4 py-3">
