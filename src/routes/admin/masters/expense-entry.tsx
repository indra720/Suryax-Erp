...
export const Route = createFileRoute("/admin/masters/expense-entry")({
  component: ExpenseEntryPage,
});

const ALL_COLUMNS = [
  "Action", "Date", "Voucher", "Pay To", "Project Name", "Payment Mode", 
  "Amount", "Debit To", "Bill No", "Dated", "Expense By", "Created By", "Remark"
];
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between border-b border-gray-200 pb-3">
        <h1 className="text-lg font-bold">Expense Entry</h1>
        <Dialog>
          ...
          <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
            <DialogHeader><DialogTitle>Expense-Create</DialogTitle></DialogHeader>
      ...
      <Card className="p-4 bg-white border border-gray-200">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
          ...
          <div><label className="text-xs font-bold block mb-1">Debit To</label><select className="w-full border rounded p-1.5 text-xs"><option>Select</option></select></div>
          <div><label className="text-xs font-bold block mb-1">Project Name</label><select className="w-full border rounded p-1.5 text-xs"><option>Select</option></select></div>
        </div>
      </Card>
      ...
      <Card className="p-4 bg-white border border-gray-200">
        <div className="flex flex-wrap justify-between items-center mb-3 text-xs gap-3">
          <div className="flex items-center gap-2">
            Show <select className="border rounded p-1"><option>All</option></select> entries
          </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-xs">
            ...
            <tfoot className="border-t font-bold">
                <tr><td colSpan={6} className="p-2 text-right">Total</td><td className="p-2">0.00</td></tr>
            </tfoot>
          </table>
        </div>
