...
export const Route = createFileRoute("/admin/projects/rowhouse-list")({
  component: RowhouseListPage,
});
...
function RowhouseListPage() {
  const [mapUrl] = useState(
    "https://crm.suryax.com/Public/ProjectShowMap?project_id=null&project_type=3&associate_id=1&view_mode=WEB"
  );
        ...
        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
          <div>
            <p className="text-xs text-gray-500 mb-1">
              Home › Projects › Rowhouse
            </p>
            <h1 className="text-2xl font-bold text-gray-900">Rowhouse</h1>
            <p className="text-sm text-gray-500 mt-0.5">
              Manage rowhouses under projects
            </p>
          </div>
      ...
      <div className=" pb-6 space-y-4">
        ...
        <div className="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
            ...
            <table className="w-full text-sm text-left min-w-[1300px]">
              <thead>
                <tr className="bg-gray-50 border-b border-gray-200">
                  ...
                  <th className="px-4 py-3 font-semibold text-gray-600 whitespace-nowrap">
                    Rowhouse Number <span className="text-red-500">*</span>
                  </th>
                  <th className="px-4 py-3 font-semibold text-gray-600 whitespace-nowrap">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 px-4 py-3 border-t border-gray-100 bg-gray-50/50">
            ...
            <p className="text-xs text-gray-500">1 rowhouse row</p>
          </div>
        </div>
      </div>
    </div>
