...
export const Route = createFileRoute("/admin/projects/facebook-form-map")({
  component: FacebookFormMapPage,
});
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
          <div>
            <p className="text-xs text-gray-500 mb-1">
              Home › Projects › Facebook Form Map
            </p>
            <h1 className="text-2xl font-bold text-gray-900">
              Facebook Form Map with Project
            </h1>
          </div>
        </div>
      </div>
